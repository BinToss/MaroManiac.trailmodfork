...
namespace TrailMod
{
    ...
    public class TrailModConfig
    {
        ...
        public int sparseToVerySparseGrassTouchCount = 3;
        public int verySparseToSoilTouchCount = 5;
        public int soilToTrampledSoilTouchCount = 7;
        public int trampledSoilToNewTrailTouchCount = 10;
