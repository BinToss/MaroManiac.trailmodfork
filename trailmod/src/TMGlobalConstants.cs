namespace TrailMod
{
    public class TMGlobalConstants
    {
        ...
        public static bool onlyPlayersCreateTrails              = true;
        ...
        public static int sparseToVerySparseGrassTouchCount = 3;
        public static int verySparseToSoilTouchCount        = 5;
        public static int soilToTrampledSoilTouchCount      = 7;
        public static int trampledSoilToNewTrailTouchCount  = 10;
